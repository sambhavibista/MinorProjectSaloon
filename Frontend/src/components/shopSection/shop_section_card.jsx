        ...
        <CardActionArea>
          ...
          <CardContent>
            <Box sx={{ height: { xs: "40px", sm: "60px", md: "70px", lg: "80px" }, marginBottom: { xs: '2px', sm: "3px" }, margin: '0px 1px' }}>
              <Typography className="responsive_fontsize24" sx={{ color: '#ff5757' }} gutterBottom variant="h5" component="div">
                {price}
              </Typography>
              <Typography className="responsive_fontsize14" sx={{ color: '#ff5757' }} variant="body2" color="text.secondary">
                {title}
              </Typography>
